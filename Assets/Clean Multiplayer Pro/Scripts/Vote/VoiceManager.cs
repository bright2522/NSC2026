...
public class VoiceManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        // The Recorder prefab is serialized with TransmitEnabled = true, so without this
        // the mic transmits from voice-room join until the local player spawns and
        // push-to-talk gating takes over ("hot mic" window).
