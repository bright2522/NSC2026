...
namespace StarterAssets
{
	public class StarterAssetsInputs : MonoBehaviour
	{
		...
		private void OnDestroy() {
			// The InputAction lives in a shared project asset - a despawned player
			// instance must not leave dangling handlers on it. Keep the action enabled;
			// other player instances still use it.
			PushToTalkAction.action.performed -= EnablePushToTalk;
			PushToTalkAction.action.canceled -= DisablePushToTalk;
		}
	}
