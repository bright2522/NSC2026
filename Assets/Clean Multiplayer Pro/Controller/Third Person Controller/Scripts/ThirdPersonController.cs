...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : NetworkBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if (MatchManager.Instance != null && MatchManager.Instance.IsGameOver)
                return;
        ...
        private void CameraRotation()
        {
            ...
            _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier * gameSetting.SettingData.lookSensitivity;
            _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier * gameSetting.SettingData.lookSensitivity;
