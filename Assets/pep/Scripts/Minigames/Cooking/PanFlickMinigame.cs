...
namespace Pep.Minigames.Cooking
{
    public class PanFlickMinigame : MonoBehaviour
    {
        ...
        public void BuildRuntimeUi()
        {
            ...
            panelRoot.anchoredPosition = new Vector2(0f, -240f);
            ...
            statusText = CreateText("Status", panelRoot, "Flick your phone", 25, new Vector2(0f, 62f));
        ...
        private void UpdateUi()
        {
            ...
            if (statusText != null)
            {
                statusText.text = isRunning ? "Flick once quickly" : "Completed";
            }
        }
