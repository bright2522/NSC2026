...
{
    public class StringListTool : TPolymorphicListTool
    {
        ...
        public StringListTool(SerializedProperty property)
        ...
        {
            return new StringItemTool(this, index);
        }
        ...
        protected override void SetupFoot()
        {
            ...
            m_ButtonAdd = new Button(() =>
            {
                ...
                InsertItem(insertIndex, new StringItem());
            })
            {
