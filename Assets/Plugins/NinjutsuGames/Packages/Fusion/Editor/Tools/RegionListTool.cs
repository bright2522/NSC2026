...
{
    public class RegionListTool : TPolymorphicListTool
    {
        ...
        public RegionListTool(SerializedProperty property)
            : base(property, "m_Regions")
        {
        ...
        {
            return new RegionItemTool(this, index);
        }
