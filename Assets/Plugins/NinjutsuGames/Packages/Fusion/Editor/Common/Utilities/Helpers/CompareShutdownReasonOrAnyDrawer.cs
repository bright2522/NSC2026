...
{
    [CustomPropertyDrawer(typeof(CompareShutdownReasonOrAny))]
    public class CompareShutdownReasonOrAnyDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            var reason = property.FindPropertyRelative("m_ShutdownReason");
