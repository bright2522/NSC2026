...
{
    [Title("Remaining Ticks")]
    [Category("Fusion/Tick Timer/Remaining Ticks")]

    [Image(typeof(IconTimer), ColorTheme.Type.Green, typeof(OverlayTick))]
    [Description("Returns the remaining ticks of TickTimer from a NetworkObject if there is any.")]
    
    [Serializable] [HideLabelsInEditor]
    public class GetDecimalTickTimerRemainingTicks : PropertyTypeGetDecimal
    {
        ...
        public override double Get(Args args)
        {
            ...
            return timer.RemainingTicks(runner) ?? 0;
        }
        public override string String => $"Remaining Ticks from {networkObject}";
    }
}