...
{
    [Title("On Shutdown")]
    [Category("Fusion/Session/On Shutdown")]
    ...
    [Serializable]
    public class EventShutdown : Event, INetworkRunnerCallbacks
    {
        [SerializeField] private CompareShutdownReasonOrAny m_Reason = new();
