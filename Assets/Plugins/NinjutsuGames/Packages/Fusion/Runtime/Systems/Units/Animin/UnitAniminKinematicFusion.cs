...
{
    /*[Title("Fusion Kinematic")]
    [Image(typeof(IconCharacterRun), ColorTheme.Type.Green)]
    
    [Category("Fusion Kinematic")]
    [Description("Default animation system for characters")]

    [Serializable]
    public class UnitAnimimKinematicFusion : TUnitAnimim
    {
        [SerializeField] protected bool useFusionPhysics;
        ...
        public override void OnStartup(Character character)
        {
            ...
            networkObject = character.GetComponent<NetworkObject>();
        ...
        public override void OnUpdate()
        {
            ...
            var deltaTime = useFusionPhysics ? networkObject.Runner.DeltaTime : Character.Time.DeltaTime;
